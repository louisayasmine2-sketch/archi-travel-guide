...
const allArticles = [
  ...
  A(
    ...
    [
      ...
      { q: "Can families follow this itinerary?", a: "Yes, but shorten museums, choose one gentle day-three destination, and prioritise open space. Our Siena with kids guide covers the pacing." }
    ],
    "2026-07-11",
  ...
  A(
    ...
    [
      ...
      },
      {
        ...
        "body": "Siena station is outside and below the historic centre. The city is reachable by local transport, escalator systems, taxi, or a demanding walk.\n\nTravellers with luggage, children, mobility limitations, or a tight schedule should choose the transfer before boarding the train. The central arrival of some buses can be more convenient, which is why [Florence to Siena by train or bus](/florence-to-siena-by-train-or-bus/) compares more than journey time."
      },
      {
...
It is not automatic, and not every property arranges it, which is why [the Siena hotels that actually solve parking](/blog/best-siena-hotels-with-parking/) is worth reading before you book a room and a car separately.
...
Parking in Siena is straightforward once you accept the basic rule: the car stays outside the walls, and you walk or ride in. The visitors who struggle are the ones who tried to get closer.` },
      { id: 'next-steps', heading: 'Next steps', body: `Before you drive anywhere near Siena, read our guide to [avoiding a Siena ZTL fine](/blog/siena-ztl-fines-how-to-avoid/) — the cameras run 24 hours a day and the fine reaches you months later through your rental company. Not sure the car is worth it? [Florence to Siena by train or bus](/florence-to-siena-by-train-or-bus/) compares the two public options — the bus arrives beside the old town, the train below it — with fares and timetables checked against the operators. If you are arriving by air instead, our guide to [reaching Siena from Florence Airport](/blog/siena-from-florence-airport-transfer/) covers the bus route and real fares.` }
    ],
    [
    ...
    [
      ...
      { id: "quick-answer", heading: "Quick answer", body: "The cheapest reliable route is the **tram plus the 131R bus**, and it costs about **€11.90** if you buy both tickets at machines or online rather than from a driver — both fares checked 3 August 2026.\n\n- **Stage 1 — Airport to central Florence:** Tram line T2 from the Peretola Aeroporto stop outside arrivals to the Santa Maria Novella area. €2.00, about 20 minutes.\n- **Stage 2 — Florence to Siena:** The 131R fast bus from Firenze Autostazione to Siena. €9.90 bought at the counter or online (€16.00 if you buy on board), about 75 minutes.\n\nRealistic door-to-door time, including the transfer and a typical wait for the bus, is **two and a quarter to two and three-quarter hours**. Budget more if you land at a busy time or your bags are slow.\n\nThe single most important thing to get right is not the route but the ticket: **validate your bus ticket the moment you board**. More on that below, because getting it wrong means a fine even though you paid." },
    ...
    [
      ...
      { q: "How much does it cost to get from Florence Airport to Siena?", a: "The cheapest reliable route costs about €11.90: the tram into Florence at €2.00, plus the 131R bus to Siena at €9.90 bought at a ticket counter, fares checked 3 August 2026. Buying the bus ticket on board instead raises it to €16.00 for that leg." },
      { q: "How long does the journey take?", a: "Allow two and a quarter to two and three-quarter hours door to door. The tram is about 20 minutes and the 131R about 75 minutes, but you also need to add the transfer in Florence and a wait for the bus." },
...
Siena works as a day trip and rewards an overnight. What it does not reward is arriving without knowing which you have chosen — because the bus deadline, the parking rate and the tower tickets all quietly depend on that decision.` },
    ...
    [
      ...
      { q: "How much does a day trip to Siena cost?", a: "Return bus transport from Florence is €19.80 per person bought at a counter, or €32.00 bought from the driver, as checked on 3 August 2026. If you drive, parking ranges from free at Il Campino to €2.50 a day at the Policlinico car parks and €35 at the central ones. Attraction tickets are extra." },
...
Florence from Siena is a good day out and an easy journey. The visitors who come away disappointed are almost always the ones who picked a Monday, assumed they could buy gallery tickets at the door, or discovered the last bus after ordering dinner. None of those is bad luck — all three are avoidable with fifteen minutes of planning before you leave.` },
      { id: 'next-steps', heading: 'Next steps', body: `Staying in Siena and arriving by air? Our guide to [reaching Siena from Florence Airport](/blog/siena-from-florence-airport-transfer/) covers the two-stage bus route and the real fares. If you are driving in Tuscany at all, read our [Siena ZTL guide](/blog/siena-ztl-fines-how-to-avoid/) first — the same camera system operates in both cities, and the fine takes months to find you. For what a Florence day costs once tickets, lunch and the bus are all counted, see [our Florence budget guide](/blog/florence-travel-budget-guide/).` },
    ],
    [
...
*   **Clothing:** Loose, light-coloured linen or cotton pieces that breathe and reflect sunlight. Wide-brimmed hats, sunglasses, and a light scarf or shawl (essential for entering churches where shoulders and knees must be covered).
...
If the day turns into more than a day, three guides pick up where this one stops. [The complete Siena day-trip guide](/siena-day-trip-from-florence/) goes further on arrival points and the timing that decides whether you get the golden hour. [One day in Siena](/one-day-in-siena/) is the hour-by-hour walk once you are standing in the Campo. And [the seven-day Tuscany itinerary from a Florence base](/blog/7-day-tuscany-itinerary-independent-travellers-2026-florence-base/) shows what the same bus network reaches over a week.`,
      },
    ],
    [
      {
...
A simple linen capsule wardrobe helps you look effortlessly chic — Italians favour polished but relaxed looks, so skip graphic tees or athletic wear.
...
*   **Heat Protection Must-Haves:** Wide-brim sun hat, polarised sunglasses, SPF 50+ sunscreen (reapply often — the Tuscan sun is intense), and a reusable water bottle. Florence’s public fountains provide free, safe drinking water.
    ...
    [
      {
        ...
        a: 'Lightweight linen, cotton, and breathable natural fibres in neutral or soft earth tones. Midi dresses and linen pants are versatile winners — they stay cool, look polished, and meet church modesty rules with a simple scarf.',
      },
      {
...
Only have one countryside day and cannot decide? [Val d’Orcia or Chianti](/blog/val-dorcia-or-chianti-which-to-visit-2026/) compares the two directions on driving time, wine, and what each one looks like in the season you are travelling.`,
      },
    ],
    [
...
If you are coming for the week rather than the ninety seconds, [Ferragosto and Palio week](/blog/siena-ferragosto-and-palio-week/) sets out date by date what is open, what closes and which buses thin out.

And a matter of manners, since it comes up: the contrade are living neighbourhood institutions, not a costume event. [Our guide to the seventeen contrade](/siena-contrade-guide/) explains what they are before you walk into one of their streets. Dinners, ceremonies and church blessings are their own, and are best watched from a respectful distance rather than photographed at close range.
  ...
  A(
    ...
    [
      ...
      },
      {
        ...
        body: `Close enough that the comparison is really about nights, not geography. The **131R fast bus** links central Florence with Siena in about **75 minutes**, at **€9.90** bought online or at the counter (€16.00 on board), as checked on 3 August 2026 — and it arrives on the practical side of Siena’s historic centre. The **train** takes around an hour and a half with a change or slow service via Empoli, and arrives below Siena’s old town, which matters with luggage.
...
Whichever way you land, the two cities are seventy-odd minutes apart and the ticket costs less than a museum entry. The stakes are real but not ruinous — and the traveller who chooses “wrong” has merely booked the first half of their next trip. In our experience, that next trip almost always happens: Florence sends people home with a camera roll, Siena sends them home with a reason to return, and the best itineraries are built by travellers honest about which souvenir they want more.`,
    ...
    [
      ...
      { q: 'How do you get from Florence to Siena?', a: 'The 131R fast bus takes about 75 minutes and costs €9.90 online or at the counter (€16.00 aboard) as checked on 3 August 2026, arriving near Siena’s historic centre. The train takes around 90 minutes and arrives below the old town.' },
...
**Open-air opera runs right through it**: the Puccini Festival plays lakeside at Torre del Lago until 5 September, with a 21:15 curtain that turns the heat into an asset rather than an obstacle. [Our independent-traveller guide](/blog/puccini-festival-torre-del-lago-2026-independent-traveller-guide/) covers reaching it from Siena or Florence, which seats are worth paying for, and what a night that finishes near midnight does to the next morning.
