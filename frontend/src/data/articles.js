...
const allArticles = [
  ...
  A(
    ...
    [
      ...
      { id: "what-a-fine-costs", heading: "What a Siena ZTL fine costs", body: "Here this guide will be more careful than most, and deliberately so. Search around and you will find travel sites quoting confident figures for a Siena ZTL fine — €83, €90–100, €80–130, even ranges up to €335. They disagree because the base penalty for a ZTL violation is set nationally under the Italian highway code and varies by city and circumstance, and because many of those figures are lifted from other cities entirely.\n\nThe Comune di Siena does not publish a single headline figure for a ZTL transit fine on its public pages; the exact amount appears on the *verbale* you receive. As a rough guide only — not a figure to rely on for Siena specifically — ZTL transit fines in Italy commonly fall in the region of €80–100 per violation before the rental company's admin fee. Treat any precise number you see online, including in this paragraph, as an estimate until you see your own notice.\n\nThere is, however, one genuinely useful and official cost detail. According to the Comune di Siena's sanctions office, there is a window between the initial notice (the *preavviso*) and the point at which it becomes a formal *verbale*. If you pay during that window, you pay the penalty **without** the notification costs that the law adds once it becomes a verbale. In plain terms: paying promptly is cheaper, and now you know exactly why — you avoid the added *spese di notifica*. Do not ignore the first notice hoping it goes away; ignoring it is the one certain way to pay more." },
      { id: "how-to-pay", heading: "How to pay, and the trap for non-European cards", body: "If you do receive a fine, you can view the photographic evidence and manage the process through Siena's official portal at [siena.multeonline.it](https://siena.multeonline.it/), and the ZTL control office can be reached at ztlsi@comune.siena.it. Using the official channels matters: it is where you can see the actual photograph of your vehicle at the gate, which is worth checking before you pay.\n\nItalian municipal fines are generally paid through PagoPA, the national government payment platform. This is where travellers from outside Europe often hit a wall: PagoPA runs on a network of Italian banks, and foreign cards — US-issued credit cards in particular — are sometimes rejected. If your card fails, the fallback is an international bank transfer to the municipality's account, the details of which should be on your notice. Build in time for this; it is not always instant, and the payment deadlines on the notice still apply." },
      { id: "park-outside-the-walls", heading: "The reliable way to avoid all of it: park outside the walls", body: "Everything above disappears if you simply do not drive into the centre. Siena is small, and the car parks just outside the walls are well placed for walking in — some connected to the centre by escalators that carry you up the hill.\n\nThe main options sit around the edge of the old town: the large Fortezza/Stadio car park to the north, Santa Caterina with its escalators running up into the centre, and the car park down by the railway station, which is usually the cheapest for a full day. Hourly rates at the edge-of-town car parks run at around €2 per hour; the station lot is cheaper for longer stays. Several of these car parks also offer a discounted hotel rate — commonly around €25 per day against roughly €35 at the standard rate — if your accommodation books it for you, so it is worth asking your hotel before you arrive.\n\nPark in one of these, walk or ride up into the centre, and the ZTL is simply not your problem. For most visitors this is the whole answer." },
    ...
    [
      ...
      { q: "How much is a ZTL fine in Siena?", a: "The exact amount is set under the Italian highway code and appears on the official notice (verbale) you receive; Siena does not publish a single headline figure. As a rough guide, Italian ZTL transit fines commonly fall around €80–100 per violation, before your rental company adds an administrative fee of roughly €25–60 per fine. Treat any precise figure as an estimate until you see your own notice." },
      { q: "Will I get multiple fines?", a: "You can. Each camera gate you cross is a separate fine, so a single wrong loop through the centre — in and out through different gates — can produce two or three fines, each with its own rental admin fee." },
      ...
      { q: "Can I just ignore a ZTL fine once I'm home?", a: "No. Italy pursues fines across borders, and ignoring the first notice only adds notification costs to the amount you owe. If you receive one, check the photographic evidence at the official portal and pay promptly." },
