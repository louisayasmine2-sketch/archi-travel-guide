...
const DOCS = {
  privacy: {
    ...
    sections: [
      ...
      { h: "Third parties", b: "We use standard analytics providers: Google Analytics, Microsoft Clarity and Amplitude." },
    ],
  },
  cookie: {
    title: "Cookie Policy",
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] font-sans overflow-hidden">
      ...
      <section className="relative py-32 bg-[#2C211B] text-white overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-10" style={{ backgroundImage: "url('/images/siena/01-hero-palazzo-pubblico-torre-del-mangia.webp')" }}></div>
