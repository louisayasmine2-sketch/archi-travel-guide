...
| 34 | **Horse welfare and the veterinary regime at the Palio** — an editorial gap, not an external trigger | as soon as it can be researched properly | Comune di Siena, Ministero della Salute, contrada and Palio official positions, veterinary reporting | `palio-di-siena-guide`, `siena-contrade-guide` | Our Palio guide mentions horses 22 times and welfare zero times. This is the question most English-speaking readers arrive with; the contrade guide currently states plainly that we have not researched it. Research and publish, or the silence reads as evasion |  |
